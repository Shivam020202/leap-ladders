...
export default function StoryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F3] text-[var(--fg)] font-sans no-rounded">
      ...
      <section
        id="hero"
        className="border-b border-[#E7E7E7] bg-[#FFF8F3] relative overflow-hidden"
      >
            ...
            <div className="lg:col-span-7">
              ...
              >
                ...
                <p className="text-[17px] leading-[1.7] text-[#0B5E6F] font-medium">
                  To put it plainly, it all started when four women with solid
                  corporate pedigrees, and even stronger opinions and diverse
                  backgrounds just took a shot. That's the only story actually.
                  No grand business plans, no investor decks, no endless
                ...
                >
                  <p>
                    The situation: the 9-to-9 grind wasn't working anymore with
                    increasing traffic on the road and general madness of
                    running around with chronic shortage of sleep.
                  </p>
                  <p>
                    So why not make better use of their time and their brain
                    cells to create and build something of their own? A little
                    more human, collective determination and with a lot of
                    'good' coffee they turned their corporate wisdom into
                    workable, practical, personal and a powerful HR training and
                    leadership program.
                  </p>
                  <p>
                    It began as one project and soon it gathered pace – more
                    clients, more ideas and a strong urge to put it all out
                    there. Because great work deserves to be seen (and
                    occasionally shown off).
                  </p>
                </motion.div>
                ...
                >
                  So here we are – four women, one ladder, and plenty of leaps
                  ahead.
                </motion.p>
              </motion.div>
            </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              >
                ...
                <div className="border-[1.5px] border-[#E7E7E7] bg-[#FFF8F5] p-8 mt-2 ml-2">
                  <svg
                    className="w-8 h-8 text-[#E89161] mb-4 opacity-30"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <p className="text-[15px] leading-[1.8] text-[#0B5E6F] font-medium">
                    No strategy slides. No investor decks. Just curiosity,
                    craft, and a stubborn desire to do HR better for real
                    people.
                  </p>
          ...
          >
            {experts.map((expert, index) => (
              <motion.button
                ...
                style={{
                  backgroundColor:
                    activeIndex === index ? expert.color : undefined,
                }}
              >
                {expert.tab}
              </motion.button>
