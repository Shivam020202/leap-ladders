                ...
                <div>
                  ...
                  >
                    ...
                    <option value="coaching">
                      Transform Your People (Coaching)
                    </option>
                    <option value="toolkits">
                      Method in the Madness (Toolkits)
                    </option>
          ...
          >
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-[16px]  text-[#0B5E6F] mb-1">
                    LinkedIn DM
                  </h3>
                ...
                <svg
                  className="w-5 h-5 text-[#E89161] transition-transform duration-300 group-hover:translate-x-1"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-[16px] text-[#0B5E6F] mb-1">WhatsApp</h3>
                  <p className="text-[14px] text-[#4A5568] leading-[1.6]">
